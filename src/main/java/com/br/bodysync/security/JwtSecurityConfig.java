package com.br.bodysync.security;
...
import com.br.bodysync.service.impl.UserDetailsServiceImpl;
...
public class JwtSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((authorize) -> authorize
                .requestMatchers("/administrator", "/administrator/**").hasAnyAuthority("SCOPE_ADMIN")
